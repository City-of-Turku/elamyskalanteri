...
const App = (props: AppProps) => {
  ...
  const { setTitle, setDescription, setStyle, setListView, setNumOfView, setHideSearchCriteria, setLanguageSelection } = bindActionCreators(optionsSlice.actions, dispatch)
