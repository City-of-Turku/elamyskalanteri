      ...
      <Grid container p={4} justifyContent="center" component="div" className={classes.root} spacing={8}>
            <Grid component="div" item xs={5} sx={{display: 'inline-table'}}>
              ...
              <Typography sx={{display: "flex", flexDirection: "row", pb: 4, cursor: "pointer"}} variant="subtitle2">
                ...
                <Typography sx={{fontWeight: 400, fontSize: 16, maxWidth: 700, pb: 4, letterSpacing: 0.01, fontStyle: 'regular'}} variant="body2">
                  {data?.short_description?.fi}
                </Typography>
                <Divider textAlign="left" sx={{width: 143}} />
                <Typography sx={{fontWeight: "light", fontSize: "default", maxWidth: 623, pt: 4}} variant="body2">
                  {data?.description?.fi}
                </Typography>
            </Grid>
          <Grid component="div" item>
            <Grid width={340} minHeight={300} sx={{p:4, backgroundColor: 'primary.dark', pt: 5, wordWrap: 'break-word'}}>
